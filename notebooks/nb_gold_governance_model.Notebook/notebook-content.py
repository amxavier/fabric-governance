...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "00000000-0000-0000-0000-0000000000d0",
# META       "default_lakehouse_name": "lh_gold",
# META       "default_lakehouse_workspace_id": "00000000-0000-0000-0000-000000000001",
# META       "known_lakehouses": [
# META         {
# META           "id": "00000000-0000-0000-0000-0000000000d0"
# META         },
# META         {
...
# **Source:** `lh_silver` → `silver_capacities`, `silver_workspaces`, `silver_items`, `silver_activity_events`, `silver_refresh_history`
# **Destination:** `lh_gold` → `dim_capacity`, `dim_workspace`, `dim_item`, `dim_user`, `dim_date`, `fact_activity`, `fact_refresh`
