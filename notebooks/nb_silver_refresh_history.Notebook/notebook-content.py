...
# **Source:** `lh_bronze_governance` → Delta Table `raw_refresh_history`, joined to `lh_silver_governance` → `silver_items`
# **Destination:** `lh_silver_governance` → Delta Table `silver_refresh_history`
